Create one custom horizontal animation strip for Peachy named `sunburn`.

Use the canonical Peachy image for identity. Use an 8-slot horizontal layout for slot count, spacing, centering, and padding; do not draw the guide.
...
Identity lock: same Peachy in every frame: soft chibi sticker sprite, slightly smoother layered pink hair, white floppy puppy ears, one small white puppy tail, human face, a noticeably feminine fuller bust that still stays tasteful and readable at chibi size, black eyes with slight dark circles, denim pants, square-toe creamy slippers. Start with the usual light blue outer jacket, then remove it later in the sequence so the inner white tank top or sleeveless undershirt is visible. No red hair, fox tail, school uniform, logos, text on clothes, or extra accessories.
...
Style and staging rules:
- keep the same sticker/chibi rendering style and outline weight as the existing pet
- keep body size and baseline reasonably consistent across frames
- the cup must disappear for this whole custom strip
- the hot face in the early frames should feel mildly heat-struck, not medically distressed
- do not show any fanning gestures in frames 1 to 3
- the first three frames must clearly read as direct jacket-removal action, not waiting, not waving, not cooling with hands
- the jacket-off pose should read clearly at pet size
